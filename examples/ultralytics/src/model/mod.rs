...
pub mod yolo11n_t_b8b_fp16 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp16/yolo11n-t-b8b.fp16.rs"
    ));
}
...
pub mod yolo26n_t_b8f_fp16 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp16/yolo26n-t-b8f.fp16.rs"
    ));
}
...
pub mod yolov5n_t_b7b_fp16 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp16/yolov5n-t-b7b.fp16.rs"
    ));
}
...
pub mod yolov8n_t_b86_fp16 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp16/yolov8n-t-b86.fp16.rs"
    ));
}
...
pub mod yolo11n_t_b8b_fp32 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp32/yolo11n-t-b8b.fp32.rs"
    ));
}
...
pub mod yolo26n_t_b8f_fp32 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp32/yolo26n-t-b8f.fp32.rs"
    ));
}
...
pub mod yolov5n_t_b7b_fp32 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp32/yolov5n-t-b7b.fp32.rs"
    ));
}
...
pub mod yolov8n_t_b86_fp32 {
    include!(concat!(
        env!("OUT_DIR"),
        "/model_fp32/yolov8n-t-b86.fp32.rs"
    ));
}
...
pub const YOLO11N_T_B8B_FP16_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolo11n-t-b8b.fp16.onnx"
);
/// Absolute path to the committed `yolo11n-t-b8b.fp32.onnx` source model.
pub const YOLO11N_T_B8B_FP32_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolo11n-t-b8b.fp32.onnx"
);
/// Absolute path to the committed `yolo26n-t-b8f.fp16.onnx` source model.
pub const YOLO26N_T_B8F_FP16_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolo26n-t-b8f.fp16.onnx"
);
/// Absolute path to the committed `yolo26n-t-b8f.fp32.onnx` source model.
pub const YOLO26N_T_B8F_FP32_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolo26n-t-b8f.fp32.onnx"
);
/// Absolute path to the committed `yolov5n-t-b7b.fp16.onnx` source model.
pub const YOLOV5N_T_B7B_FP16_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolov5n-t-b7b.fp16.onnx"
);
/// Absolute path to the committed `yolov5n-t-b7b.fp32.onnx` source model.
pub const YOLOV5N_T_B7B_FP32_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolov5n-t-b7b.fp32.onnx"
);
/// Absolute path to the committed `yolov8n-t-b86.fp16.onnx` source model.
pub const YOLOV8N_T_B86_FP16_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolov8n-t-b86.fp16.onnx"
);
/// Absolute path to the committed `yolov8n-t-b86.fp32.onnx` source model.
pub const YOLOV8N_T_B86_FP32_ONNX: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/model/yolov8n-t-b86.fp32.onnx"
);
